...
export const IconDeployGreen = ({ ...props }) => (
    <IconImg src={'/static/img/icon-deploy-green.svg'} {...props} />
);
export const IconAddFile = ({ ...props }) => (
    <svg
        ...
        height="16"
    >
        <polygon points="12,3 8,3 8,4 11,4 11,7 14,7 14,14 6,14 6,8 5,8 5,15 15,15 15,6" />
        <path
...
export const IconAddFolder = ({ ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16">
        <polygon points="9,3 8,5 8,2 6,2 6,0 2,0 2,2 0,2 0,6 2,6 2,8 2,15 16,15 16,3" />
        <path
            d="M14 4h-4.382l-1 2h-2.618v2h-3v6h12v-10h-1zm0 2h-3.882l.5-1h3.382v1z"
            fill="#FFFFFF"
        />
        <polygon
            points="7,3.018 5,3.018 5,1 3.019,1 3.019,3.018 1,3.018 1,5 3.019,5 3.019,7 5,7 5,5 7,5"
            fill="#FFFFFF"
        />
        <polygon points="14,5 14,6 10.118,6 10.618,5" {...props} />
    </svg>
);
...
export const IconContract = ({ ...props }) => (
    <IconImg src={'/static/img/icon-solidity.svg'} {...props} />
);
export const IconHtml = ({ ...props }) => (
    <IconImg src={'/static/img/icon-html.svg'} {...props} />
);
export const IconJS = ({ ...props }) => (
    <IconImg src={'/static/img/icon-js.svg'} {...props} />
);
export const IconCss = ({ ...props }) => (
    <IconImg src={'/static/img/icon-css.svg'} {...props} />
);
export const IconMd = ({ ...props }) => (
    <IconImg src={'/static/img/icon-md.svg'} {...props} />
);
export const IconShowPreview = ({ ...props }) => (
    <svg
        fill="currentColor"
    ...
    >
        <path
            d="M27,33 L173,33 C178.522847,33 183,37.4771525 183,43 L183,157 C183,162.522847 178.522847,167 173,167 L27,167 C21.4771525,167 17,162.522847 17,157 L17,43 C17,37.4771525 21.4771525,33 27,33 Z M29,64 L29,156 L171,156 L171,64 L29,64 Z M84.260356,82.6998802 L119.974518,107.161635 C121.797124,108.409995 122.262642,110.899505 121.014282,112.722111 C120.734924,113.129973 120.38238,113.482517 119.974518,113.761875 L84.260356,138.223629 C82.4377502,139.471989 79.9482404,139.006471 78.6998802,137.183866 C78.2439706,136.518238 78,135.730302 78,134.92351 L78,86 C78,83.790861 79.790861,82 82,82 C82.8067925,82 83.594728,82.2439706 84.260356,82.6998802 Z"
            id="Combined-Shape"
            fill="inherit"
            {...props}
        />
